...
const hostPlatform = (() => {
  ...
  if (platform === 'linux') {
    ...
    if ((distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === 'debian' && (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.version) === '') return 'debian12' + archSuffix;
